//! This is the pairing module for the bls12-381 signature library
//! Copyright (c) 2025 zk-evm
//! SPDX-License-Identifier: Apache-2.0
//!
//! It creates a pairing struct for the bls12-381 signature library
...
pub const Pairing = struct {
    ...
    // msgs and scalar should have len > 0
