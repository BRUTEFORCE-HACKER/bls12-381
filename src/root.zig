//! This is the root module for the bls12-381 signature library
//! Copyright (c) 2025 zk-evm
//! SPDX-License-Identifier: Apache-2.0
//!
//! It exports the createMemoryPool function and the min_pk and min_sig modules
//! The min_pk and min_sig modules are exported as structs with the PublicKey, AggregatePublicKey, Signature, AggregateSignature, SecretKey, and aggregateWithRandomness fields
//! The createMemoryPool function is exported as a function that returns a MemoryPool struct
//! The MemoryPool struct is exported as a struct with the getPublicKeyScratch, returnSignatureScratch, returnPairingBuffer, and deinit fields
//! The MemoryPool struct is used to create a memory pool for the bls12-381 signature library
//! The min_pk and min_sig modules are used to create a memory pool for the bls12-381 library
//! The createMemoryPool function is used to create a memory pool for the bls12-381 library
