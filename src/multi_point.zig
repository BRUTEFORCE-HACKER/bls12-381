//! This is the multi_point module for the bls12-381 signature library
//! Copyright (c) 2025 zk-evm
//! SPDX-License-Identifier: Apache-2.0
//!
//! It creates a multi_point struct for the bls12-381 signature library
    ...
    return struct {
        ...
        pub fn testMult() !void {
            ...
            for (0..n_points) |i| {
                ...
                // this is not efficient as it contains duplicate work
