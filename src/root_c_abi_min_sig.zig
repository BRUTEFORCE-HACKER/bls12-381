//! This is the root_c_abi_min_sig module for the bls12-381 signature library
//! Copyright (c) 2025 zk-evm
//! SPDX-License-Identifier: Apache-2.0
//!
//! It creates a root_c_abi_min_sig struct for the bls12-381 signature library
...
// sync exported C-ABI functions from min_pk
